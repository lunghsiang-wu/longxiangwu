...
new_data.loc[new_data['default'] == 'unknown', 'default'] = new_data["default"].value_counts().index[0]
new_data.loc[new_data['education'] == 'unknown', 'education'] = new_data["education"].value_counts().index[0]
```
...
new_data["label"]=0
new_data.loc[new_data["y"]=="yes", "label"]=1
new_data.loc[new_data["y"]=="no", "label"]=0
del new_data["y"] 
```
